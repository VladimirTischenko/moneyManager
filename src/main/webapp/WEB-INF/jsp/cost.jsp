...
<section>
    ...
    <h3><spring:message code="${cost.isNew() ? 'costs.add' : 'costs.edit'}"/></h3>
    <hr>
    <form method="post" action="costs">
        <input type="hidden" name="id" value="${cost.id}">
        <dl>
            <dt><spring:message code="costs.dateTime"/>:</dt>
            <dd><input type="datetime-local" value="${cost.dateTime}" name="dateTime"></dd>
        </dl>
        <dl>
            <dt><spring:message code="costs.description"/>:</dt>
            <dd><input type="text" value="${cost.description}" size=40 name="description"></dd>
        </dl>
        <dl>
            <dt><spring:message code="costs.price"/>:</dt>
