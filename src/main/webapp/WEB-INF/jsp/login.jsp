...
<div class="container">
    <div class="lead">
        ...
        профилем и данными (день, расходы, суммы) через UI (по AJAX) и по REST интерфейсу с базовой авторизацией.
        Возможна фильтрация данных по датам и времени, при этом цвет записи таблицы расходов зависит от того, превышает ли
        сумма за день норму (редактируемый параметр в профиле пользователя).
